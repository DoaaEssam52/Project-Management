...
import {
  AuthErrorMessages,
  MyErrorStateMatcher,
} from '../../validations/auth-error-messages';
...
export class RegisterComponent implements OnInit {
  // 1//
  ngOnInit(): void {
    this._AuthService.authTitle.next('Register Account');
    this._AuthService.authBackgroundImage.next('assets/images/bg-2.jpeg');
  }
  // ==================================================
  // 2//
  constructor(
